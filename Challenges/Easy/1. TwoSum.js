...
// function twoSum(array, target) {
//   let obj  = {}; // storing key = the element, value = index
//   let possibleMatch = {}; 
//   let possibleInt;
//   // let result;
  

//   // iterate on every element of the array
//   for (let i = 0; i < array.length; i++) {
//      // if the possible-matching-element is found in the obj, return the curr index and obj's value
//     if (possibleMatch.hasOwnProperty([array[i]])) {
//       return [possibleMatch[array[i]], i];
//     }
//     // if the element is smaller than target, store it in the obj & possibleMatch.
//     if (array[i] <= target) {
//       obj[array[i]] = i;  // storing key = the element, value = index
//       possibleInt = target - array[i];
//       console.log(possibleInt);
//       possibleMatch[target - array[i]] = i; //store key = possibleInt, value = index
//     } 
//   }
// }


// const arr1 = [2, 5, 22, 3, 1, 4, 10, 15];
// const arr2 = [-1, -2, -3, -4, -5];
// console.log(twoSum(arr1, 19));
...
var twoSum = function(nums, target) {
  ...
  for (let i = 0; i < nums.length-1; i++) {
    ...
    const index2 = previousVals[neededVal];
    if (index2 != null) {
      return [index2, i];
    } else {
...
const nums1 = [4, 2, 7, 1, 6]; 

console.log(twoSum(nums1, 5))
